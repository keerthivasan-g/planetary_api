...
app.config['MAIL_USERNAME'] = '49118f77c4e56d'
app.config['MAIL_PASSWORD'] = '4bab665b107674'
...
def db_seed():
    ...
    test_user = User(first_name='Keerthi',
                     last_name='gnanaudayan',
                     email='test@test.com',
                     password='12345')
...
def parameters():
    ...
    if age<18:
        ...
        return jsonify(message="welcome "+name+" boi")
...
def retrieve_password(email: str):
    ...
    if user:
        ...
        return jsonify(message="email not exist"),401
...
def planet_details(planet_id:int):
    ...
    if planet:
        ...
        return jsonify(message="That planet does not exist"),200
...
def add_planet():
    ...
    if test:
        return jsonify("there is already a planet exists"),409
    else:
